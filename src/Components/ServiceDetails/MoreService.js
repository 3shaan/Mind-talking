...
const MoreService = ({ id }) => {
  ...
  useEffect(() => {
    fetch(`https://mind-talking-server-3shaan.vercel.app/rest/${id}`)
      .then((res) => res.json())
  ...
  return (
    <div>
      <div class="mx-3 mt-32 block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

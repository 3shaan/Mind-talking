          ...
          <div className="container p-4 mx-auto sm:p-10">
            <div className="mb-12 space-y-4 text-center">
              ...
              <p className="px-4 sm:px-8 lg:px-24">
                ...
                choose a package and become a honorable to our community member
              </p>
            </div>
            <div className="lg:w-8/12 flex justify-between max-w-md flex-col lg:flex-row gap-10 mx-auto auto-rows-fr lg:grid-cols-3 lg:max-w-full">

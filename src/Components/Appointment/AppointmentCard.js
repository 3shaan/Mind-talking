...
const AppointmentCard = ({ data, handleSubmit }) => {
  ...
  return (
    <div>
      <div class="w-full max-w-sm px-4 py-3 bg-slate-100 hover:bg-slate-200 rounded-md shadow-xl dark:bg-gray-800 flex flex-col justify-center items-center gap-2">
        <h1>{name}</h1>
        <p>{slots[0]}</p>
        <p>
